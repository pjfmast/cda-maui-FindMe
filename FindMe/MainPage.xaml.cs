...
public partial class MainPage : ContentPage
{
    ...
    private async void OnFindMeClicked(object sender, EventArgs e)
    {
        ...
        {
            await App.Current.MainPage.DisplayAlert("Permissions Error", "FindMe needs your permission to access your location.", "OK");
            ...
            else
            {
                ...
                if (DeviceInfo.Platform == DevicePlatform.iOS || DeviceInfo.Platform == DevicePlatform.MacCatalyst || DeviceInfo.Platform == DevicePlatform.WinUI)
                {
